...
${selectedAddons ? `Options supplémentaires:\n- ${selectedAddons}\n` : ''}
Message:
${values.message}
    `.trim()
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Votre email a été préparé dans votre application de messagerie.",
      })
    }, 500)
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center bg-muted rounded-xl">
        ...
        <p className="text-muted-foreground mb-6">
          Un email a été préparé dans votre application de messagerie. Vérifiez et envoyez-le pour nous contacter.
        </p>
